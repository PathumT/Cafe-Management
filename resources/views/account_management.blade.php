                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="myForm" role="form" method="POST"
                                            ...
                                            <div class="mb-3 d-flex">
                                                ...
                                                <input type="text" name="email" class="form-control max-width-500"
                                                    id="" aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3 d-flex">
                                                <label for="name" class="form-label width-110 pt-2">User Name</label>
                                                <input type="text" name="name" class="form-control max-width-500"
                                                    id="" aria-describedby="emailHelp">
                                            </div>
                                            ...
                                            <div class="mb-3 d-flex" style="width: 1000px">
                                                ...
                                                <select required name="role"
                                                    class="form-select max-width-500 bordered-input"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select id="role-filter" class="form-control">
                                            ...
                                            <option style="color: #f70606;" role="0" class="font-weight-bold">Customer
                                            </option>
                                            <option style="color: #f70606;" role="1" class="font-weight-bold">Super
                                                Admin</option>
                                            <option style="color: #f70606;" role="2" class="font-weight-bold">Manager
                                            </option>
                                            {{-- <option role="3">Developer</option> --}}
                                            <option style="color: #f70606;" role="4" class="font-weight-bold">Employee
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <table class="table table-striped" id="table1">
                                        ...
                                        <tbody>
                                            @foreach ($accounts as $key => $item)
                                                @if ($item->role == '1' || $item->role == '2' || $item->role == '4')
                                                    <tr>
                                                        <td class="id">{{ ++$key }}</td>
                                                        <td class="name">{{ $item->name }}</td>
                                                        <td class="email">{{ $item->email }}</td>
                                                        @if ($item->role == '1')
                                                            <td class="role_name"><span class="badge bg-danger">Super
                                                                    Admin</span></td>
                                                        @elseif ($item->role == '4')
                                                            <td class="role_name"><span
                                                                    class="badge bg-success">Employee</span></td>
                                                        @elseif ($item->role == '0')
                                                            <td class="role_name"><span
                                                                    class="badge bg-success">Customer</span></td>
                                                        @elseif ($item->role == '2')
                                                            <td class="role_name"><span
                                                                    class="badge bg-success">Manager</span></td>
                                                        @endif
